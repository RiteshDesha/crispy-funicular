...
Adds aggressive red dashed TILR / survey-number line detection using wider red masks, directional dash merging, Hough lines, and component-axis fallback. TILR lines are returned separately on `DP_TILR_SURVEY_LINES`.
